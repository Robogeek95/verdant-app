...
import {
  ChevronRight, User, HeartFill, Cart, CartFill, TrashFill,
  ...
  <div>
    <Row>
      <Col sm={12} md={12} lg={12} className="py-3">
        <h6 style={{ fontSize: '18px', fontWeight: '400', lineHeight: '26.44px' }}>
          Home
          <ChevronRight />
          {' '}
          <span style={{ fontSize: '18px', fontWeight: '400', lineHeight: '26.44px' }}>Account Details</span>
          <ChevronRight />
          <span className="text-primary" style={{ fontSize: '18px', fontWeight: '500', lineHeight: '26.44px' }}>Saved Items</span>
        </h6>
      </Col>
    </Row>
          ...
          <Card.Body>
            <Row>
              <Col
                ...
                lg={4}
                style={{
                  background: '#FCFCFC', boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.07)', padding: '15px 0', margin: '10px 10px', width: '224px',
                }}
              >
                ...
                <div>
                  <Card.Text>
                      Corn Flakes
                      <span style={{
                        fontSize: '8px', fontWeight: '400', lineHeight: '', color: '#F6C54C', cursor: 'pointer', marginLeft: 'auto',
                      }}
                      >
