      ...
      <div className="col-md-6">
        ...
        <div className="d-flex justify-content-even p-3">
          ...
          <div>
            ...
            <p style={subtext}>
              Select the category of the product you want to send,
        ...
        <div className="d-flex justify-content-even p-3">
          ...
          <div>
            ...
            <p style={subtext}>Select quantity and input receiver&apos;s details</p>
          </div>
        </div>
        <div className="d-flex justify-content-even p-3">
          ...
          <div>
            ...
            <p style={subtext}>You can pay with card or any form of cryptocurrency</p>
          </div>
        </div>
        <div className="d-flex justify-content-even p-3">
          ...
          <div>
            ...
            <p style={subtext}>Review the items in your cart and proceed to payment</p>
          </div>
        </div>
      </div>
      <div className="col-md-6">
