...
Required Fields<span className="text-danger">*</span> </h6>
            <h5 className="pt-2">
Step 1: Enter your DSTV details<span className="text-danger" style={{ fontSize: '24px', fontWeight: '500' }}>*</span> </h5>
          </Col>
         </Row>
        <Form>
          <Row className="mx-auto py-2">
...
Smart Card Number<span className="text-danger">*</span></Form.Label>
             ...
             <Col sm={12} md={4} lg={4}>
              <Form.Group className="mb-3 formControl" controlId="formBasicEmail">
                <Form.Label style={{ fontSize: '18px', fontWeight: '400' }}>
Bouquet<span className="text-danger">*</span></Form.Label>
             ...
             <Col sm={12} md={4} lg={4}>
              <Form.Group className="mb-3 formControl">
                <Form.Label style={{ fontSize: '18px', fontWeight: '400' }}>
Amount<span className="text-danger">*</span></Form.Label>
        ...
        <Form>
          <Row className="mx-auto py-2">
             <Col sm={12} md={4} lg={4}>
              <Form.Group className="mb-3 formControl" controlId="formBasicEmail">
                <Form.Label style={{ fontSize: '18px', fontWeight: '400' }}>
First Name<span className="text-danger">*</span></Form.Label>
             ...
             <Col sm={12} md={4} lg={4}>
              <Form.Group className="mb-3 formControl" controlId="formBasicEmail">
                 <Form.Label style={{ fontSize: '18px', fontWeight: '400' }}>
Surname<span className="text-danger">*</span></Form.Label>
             ...
             <Col sm={12} md={4} lg={4}>
              <Form.Group className="mb-3 formControl">
                <Form.Label style={{ fontSize: '18px', fontWeight: '400' }}>
Phone Number<span className="text-danger">*</span></Form.Label>
        ...
        <Form>
          ...
          <Col sm={12} md={8} lg={8}>
             <Form.Group className="mb-3 formControl" controlId="formBasicEmail">
                <Form.Label style={{ fontSize: '18px', fontWeight: '400' }}>
Card Number<span className="text-danger">*</span></Form.Label>
             ...
             <Row className="py-2">
              <Col sm={12} md={6} lg={6}>
                <Form.Group className="mb-3 formControl" controlId="formBasicEmail">
                  <Form.Label style={{ fontSize: '18px', fontWeight: '400' }}>
Expiry Date<span className="text-danger">*</span></Form.Label>
              ...
              <Col sm={12} md={6} lg={6}>
                <Form.Group className="mb-3 formControl">
                  <Form.Label style={{ fontSize: '18px', fontWeight: '400' }}>
CVC<span className="text-danger">*</span></Form.Label>
             ...
             <Row className=" py-2">
              <Col sm={12} md={6} lg={6}>
                <Form.Group className="mb-3 formControl" controlId="formBasicEmail">
                  <Form.Label style={{ fontSize: '18px', fontWeight: '400' }}>
Country<span className="text-danger">*</span></Form.Label>
                  <select className="form-control" name="" id="">
              ...
              <Col sm={12} md={6} lg={6}>
                <Form.Group className="mb-3 formControl">
                  <Form.Label style={{ fontSize: '18px', fontWeight: '400' }}>
Postal Code<span className="text-danger">*</span></Form.Label>
                  <Form.Control type="text" placeholder="Enter Phone Number" bg="secondary" />
                </Form.Group>
              </Col>
            </Row>
