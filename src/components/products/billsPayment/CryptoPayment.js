    ...
    <section className="py-3 my-5 bg-white">
        ...
        <Row className="mx-auto py-2">
          <Col sm={12} md={12} lg={12}>
             ...
             <h5 className="pt-2" style={{ fontSize: '24px', fontWeight: '500' }}>
              Step 1: Enter your DSTV details<span className="text-danger">*</span> 
            </h5>
           </Col>
        </Row>
        <Form>
          <Row className="mx-auto py-2">
            <Col sm={12} md={4} lg={4}>
               <Form.Group className="mb-3 formControl" controlId="formBasicEmail">
                <Form.Label style={{ fontSize: '18px', fontWeight: '400' }}>
                  Smart Card Number<span className="text-danger">*</span>
                </Form.Label>
            ...
            <Col sm={12} md={4} lg={4}>
               <Form.Group className="mb-3 formControl" controlId="formBasicEmail">
                <Form.Label style={{ fontSize: '18px', fontWeight: '400' }}>
                  Bouquet<span className="text-danger">*</span>
                </Form.Label>
