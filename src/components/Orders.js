    ...
    <Row>
      <Col sm={12} md={12} lg={12} className="py-3">
        <h6 style={{ fontSize: '18px', fontWeight: '400', lineHeight: '26.44px' }}>
          ...
          <ChevronRight />
          {' '}
          <span className="text-primary" style={{ fontSize: '18px', fontWeight: '400', lineHeight: '26.44px' }}>My Orders</span>
        </h6>
      </Col>
    </Row>
          ...
          <Card.Body>
            <Row>
              <Col
                ...
                lg={12}
                style={{
                  display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', padding: '50px 0',
                }}
              >
                <div>
